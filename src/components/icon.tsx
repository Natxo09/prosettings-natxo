...
interface IconProps extends SVGProps<SVGSVGElement> {
  name: "steam" | "twitch" | "twitter" | "youtube" | "mouse" | "crosshair" | "viewmodel" | "launch" | "video" | "hud" | "radar" | "knife" | "monitor" | "keyboard" | "headphones" | "mic" | "mousepad" | "cpu" | "gpu" | "user" | "github" | "cs2" | "workshop";
  size?: number;
}
...
export function Icon({ name, size = 24, className = "", ...props }: IconProps) {
  // Special case for CS2 logo with different viewBox and aspect ratio
  if (name === "cs2") {
    return (
      <svg
