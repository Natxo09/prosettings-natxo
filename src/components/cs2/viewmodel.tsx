...
const viewmodelData: ViewmodelSettings = {
  fov: 68,
  offsetX: 2.5,
  offsetY: 0,
  offsetZ: -1.5,
...
const VIEWMODEL_COMMANDS = `viewmodel_fov 68; viewmodel_offset_x 2.5; viewmodel_offset_y 0; viewmodel_offset_z -1.5; viewmodel_presetpos 1;`;
...
export function Viewmodel() {
  ...
  const handleCopy = async () => {
    try {
      await navigator.clipboard.writeText(VIEWMODEL_COMMANDS);
      setCopied(true);
    ...
    <div className="bg-card text-card-foreground rounded-2xl shadow-lg">
      ...
      <div className="p-6 border-b border-border">
        <div className="flex items-center gap-3">
          <Icon name="viewmodel" size={28} className="text-card-foreground" />
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
          <SettingItem label="FOV" value={viewmodelData.fov} />
          <SettingItem label="Offset X" value={viewmodelData.offsetX} />
          <SettingItem label="Offset Y" value={viewmodelData.offsetY} />
          <SettingItem label="Offset Z" value={viewmodelData.offsetZ} />
          <SettingItem label="Preset Position" value={viewmodelData.presetPos} />
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="relative bg-background rounded-lg p-4 border border-border">
            ...
            <button
              ...
              aria-label="Copy viewmodel commands"
            >
              {copied ? (
                <>
                  <Check size={16} />
